...
**Следствие для AC7:** бюджет в 3 секунды выполним по прогретым направлениям. На холодном направлении честное поведение — прогрессивная выдача с индикатором, а не молчаливое десятисекундное ожидание. Срок жизни их кэша не выяснен — проверяется до хакатона.

...
/**
 * Верхняя оценка стоимости поездки по ценовому классу направления.
 *
 * Замер 19 августа по снапшоту, поездки из Москвы: low медиана 33 308 ₽ при
 * максимуме 53 873, medium медиана 26 620 при максимуме 59 459, high медиана
 * 37 384 при максимуме 53 913. То есть класс плохо предсказывает итоговую
 * сумму — medium по медиане дешевле low, — а прежние пороги 35/70/120 тысяч
 * были оторваны от данных втрое.
 *
 * Из-за них бюджет в 60 тысяч отсекал Анапу и Геленджик, стоящие 26–29 тысяч,
 * лента заполнялась «запасными» городами, и человек видел Псков в ответ на
 * «хочу на море». Пороги подняты до фактических максимумов: отсев остаётся
 * страховкой от заведомо неподъёмного, а точную цену человек всё равно видит
 * на карточке вместе с пометкой о превышении бюджета.
 */
